...
//El nuevo objeto que creamos serìa un ejemplo de la informaciòn que enviariamos al área de Marketing para la difusiòn de promociones
console.log("Los daros del cliente y sus hábitos de compra son: ")
...
console.table(pedido);
//Suponiendo que el usuario ya los realizó el pago del pedido se convertira en una VENTA que requiere información de ambos objetos
//IMPORTANTE: ASSING, no solo permite la fusión de 2 o más objetos, también muta los objetos originales, perdiendo el valor original del ID en este caso
